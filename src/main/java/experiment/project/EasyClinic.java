...
public class EasyClinic implements Project {
    ...
    private static String level1BitermPath = "dataset/easyclinic/biterm/use_case";
    private static String level2BitermPath = "dataset/easyclinic/biterm/interaction_diagram";
    private static String level3BitermPath = "dataset/easyclinic/biterm/code_description";
