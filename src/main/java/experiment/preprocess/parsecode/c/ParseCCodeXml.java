...
public class ParseCCodeXml {

    private static String srcmlXmlDir;
    private Map<String, List<String>> codeFileNameMap = new HashMap<>();
    private Map<String, List<String>> codeMethodMap = new HashMap<>();
    private Map<String, List<String>> codeParamTypeMap = new HashMap<>();
    private Map<String, List<String>> codeParamNameMap = new HashMap<>();
    private Map<String, List<String>> codeFieldMap = new HashMap<>();
    private Map<String, List<String>> codeCommentMap = new HashMap<>();
    private Map<String, List<String>> codeInvokeMethodMap = new HashMap<>();
    private Set<String> allMethodSet = new HashSet<>();
    ...
    public ParseCCodeXml(Project project, String codeType) {
        this.srcmlXmlDir = project.getProjectPath() + "/unprocessed/" + codeType + "/code_xml";
    }


    private void srcmlXmlProcess() throws IOException, JDOMException {
        File filePath = new File(srcmlXmlDir);
        System.out.println(filePath.listFiles().length);
